...
async function main() {
  ...
  const quickPromptData = [
    { text: '婚礼场景', type: 'image_design' as const, items: [
      '签到台，白玫瑰花艺装饰，柔和自然光，奶油色桌布，金色相框，温馨高级感',
      '迎宾区，拱形花门，白绿色系花艺，草坪背景，清晨柔光，浪漫清新浪漫',
      '仪式区背景，巨型花墙，白粉色系，水晶吊灯，梦幻朦胧氛围',
      '宴会厅全景，圆桌白纱椅套，中央花艺，水晶吊灯暖光，优雅大气',
      '甜品台，多层婚礼蛋糕，马卡龙塔，鲜花装饰，奶油色调，精致可爱',
      'T台装饰，两侧路引花艺，花瓣铺地，追光灯效果，仪式感十足',
      '合影区，ins风背景墙，霓虹灯牌，气球拱门，网红打卡点',
      '新娘休息室，梳妆台，晨袍挂放，自然光，私密温馨'
    ]},
    { text: '花艺设计', type: 'image_design' as const, items: [
      '圆形手捧花，白玫瑰+尤加利叶，丝带绑扎，自然散落风格',
      '瀑布形手捧花，白色绣球+铃兰，垂坠绿叶，优雅浪漫',
      '胸花，单朵白玫瑰，满天星点缀，丝带蝴蝶结',
      '花门，半圆形，白粉色系花艺，绿叶缠绕，户外草坪背景',
      '花亭，四柱式，顶部垂挂花串，白色纱幔，梦幻感',
      '路引花艺，铁艺支架，单束白玫瑰，丝带飘带',
      '桌花，低矮圆形，白绿色系，蜡烛环绕，宴会视角',
      '花墙背景，密集花艺，渐变粉色，拍照打卡墙',
      '悬挂花艺，天花板倒挂花束，水晶吊坠，仰拍视角',
      '花艺拱门，不对称设计，自然野花风格，田园感'
    ]},
    { text: '婚礼风格', type: 'image_design' as const, items: [
      '法式浪漫风格，柔和自然光，野花绿植，亚麻蕾丝质感，暖奶油色调，水彩画感',
      '新中式风格，红金配色，宋式纹样，丝绸质感，灯笼元素，喜庆典雅',
      '极简现代风格，纯白空间，几何线条，留白构图，高级灰调，干净利落',
      '森系自然风格，原木绿植，苔藓蕨类，自然光斑，大地色系，清新治愈',
      '复古怀旧风格，胶片质感，暖黄调，老物件点缀，做旧纹理，时光感',
      '韩式清新风格，奶白色调，简约花艺，柔和光线，干净画面，小清新',
      '美式乡村风格，谷仓木门，向日葵，格子布，木质元素，温馨质朴',
      '波西米亚风格，流苏地毯，macramé挂毯，干花蒲苇，自由奔放感',
      '童话梦幻风格，星空顶，城堡元素，水晶灯，紫色调，魔幻浪漫',
      '日式侘寂风格，枯山水，竹艺，素色花艺，留白意境，禅意静谧'
    ]},
    { text: '色彩方案', type: 'image_design' as const, items: [
      '经典白绿色系，纯白花艺搭配翠绿叶材，清新自然，百搭不出错',
      '香槟金配色，暖金色点缀，丝绒质感，高级奢华感',
      '玫瑰粉色系，渐变粉花朵，丝带装饰，甜美少女感',
      '雾霾蓝配色，灰蓝色调，银色点缀，冷静优雅气质',
      '酒红勃艮第，深红色花艺，金色框架，浓郁复古感',
      '莫兰迪色系，低饱和度粉蓝绿，柔和高级，文艺气质',
      '黑白金经典，极简对比，金属质感，现代都市感',
      '薰衣草紫，淡紫色花艺，银色装饰，梦幻浪漫感',
      '焦糖暖棕，大地色系，木质元素，温暖质朴感',
      '薄荷绿配色，清新绿色，白色搭配，春夏户外感'
    ]},
    { text: '灯光氛围', type: 'image_design' as const, items: [
      '暖色烛光，数百支蜡烛排列，暖黄光晕，浪漫温馨氛围',
      '冷色追光灯，舞台效果，聚焦新人，戏剧性光影',
      '星空顶效果，LED灯串垂挂，深蓝背景，梦幻浪漫',
      '水晶吊灯，多盏垂挂，折射光斑，奢华宴会厅感',
      '霓虹灯牌，定制文字灯牌，彩色灯光，网红打卡风',
      '灯笼装饰，中式红灯笼，暖光透出，喜庆传统感',
      '烟花效果，夜空烟花，长曝光光轨，节日庆典感',
      '投影映射，墙面动态光影，科技感，现代婚礼秀',
      '丁达尔效应，光束穿透薄雾，神圣仪式感',
      '日落逆光，金色夕阳，剪影效果，浪漫户外婚礼'
    ]},
    { text: '拍摄视角', type: 'image_design' as const, items: [
      '俯拍全景，鸟瞰视角，展示整体场景布局和空间设计',
      '平视中景，新人互动，自然表情，情感捕捉',
      '特写细节，戒指、花艺、桌卡等精致小物，微距质感',
      '仰拍视角，花艺吊饰、星空顶，展示垂直空间设计',
      '广角全景，展示场地全貌，空间纵深感',
      '斜线构图，对角线引导视线，动态画面感',
      '前景虚化，花艺前景模糊，新人清晰，层次分明',
      '背影视角，新人背影，仪式感，留白意境',
      '框架构图，门窗花门做前景框，聚焦主体',
      '对称构图，镜像对称，庄重仪式感'
    ]},
    { text: '画面质感', type: 'image_design' as const, items: [
      '胶片相机质感，颗粒感，暖色调，复古怀旧',
      '柔焦朦胧，梦幻柔光，边缘模糊，浪漫氛围',
      '高清锐利，细节清晰，商业摄影质感',
      '水彩画风格，柔和渐变，艺术插画感',
      '油画质感，厚重色彩，古典浪漫',
      '日系清新，过曝高光，淡色调，干净治愈',
      '暗调电影感，低key光影，戏剧性，高级质感',
      '明亮通透，高key画面，干净清爽，现代感',
      '黑白摄影，去除色彩，突出光影和构图',
      '双重曝光，人像与场景叠合，艺术创意'
    ]},
    { text: '文案风格', type: 'copywriting' as const, items: [
      '温馨感人，用细腻笔触描述新人故事，引发情感共鸣',
      '浪漫唯美，诗意语言描绘婚礼画面，营造梦幻氛围',
      '幽默风趣，轻松调侃婚礼趣事，拉近与读者距离',
      '文艺清新，简约文字配优美意象，适合小红书风格',
      '大气正式，庄重措辞适合官方发布和邀请函',
      '故事叙述，以时间线讲述从相识到婚礼的完整故事',
      '对话体，模拟新人或宾客视角，增强代入感',
      '清单体，条理清晰罗列要点，适合攻略类内容'
    ]},
    { text: '文案场景', type: 'copywriting' as const, items: [
      '婚礼邀请函文案，正式邀请宾客出席，包含时间地点着装要求',
      '婚礼誓词，新人互诉衷肠，真挚感人，个性化定制',
      '婚礼回顾文案，总结婚礼亮点，感谢各方配合，适合公众号发布',
      '小红书种草文案，突出婚礼亮点和打卡点，吸引潜在客户',
      '朋友圈九宫格文案，简短精炼，配合图片讲述婚礼故事',
      '客户案例文案，展示策划能力和服务细节，用于获客转化',
      '抖音短视频脚本，15秒-60秒婚礼精彩瞬间剪辑文案',
      '感谢信文案，婚礼后感谢宾客出席，温馨得体'
    ]}
  ];
  ...
  const platformMenuData = [
    ...
    { label: '运营', icon: 'settings', sortOrder: 1, children: [
      ...
      { label: '推荐词管理', href: '/admin/quick-prompts', icon: 'sparkles', sortOrder: 3 }
    ]}
  ];
